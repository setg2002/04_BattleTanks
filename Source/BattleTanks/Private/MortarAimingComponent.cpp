...
void UMortarAimingComponent::Fire()
{
	...
	auto Projectile1 = GetWorld()->SpawnActor<AProjectile>(
		ProjectileBlueprint,
		MortarBarrel->GetSocketLocation(FName("Projectile1")),
		MortarBarrel->GetSocketRotation(FName("Projectile1"))
		);
	Projectile1->LaunchProjectile(LaunchSpeed);

	auto Projectile2 = GetWorld()->SpawnActor<AProjectile>(
		ProjectileBlueprint,
		MortarBarrel->GetSocketLocation(FName("Projectile2")),
		MortarBarrel->GetSocketRotation(FName("Projectile2"))
		);
	Projectile2->LaunchProjectile(LaunchSpeed);

	auto Projectile3 = GetWorld()->SpawnActor<AProjectile>(
		ProjectileBlueprint,
		MortarBarrel->GetSocketLocation(FName("Projectile3")),
		MortarBarrel->GetSocketRotation(FName("Projectile3"))
		);
